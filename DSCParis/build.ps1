<#
    ...
    .PARAMETER PublishToPull
        Copy the configurations and the modules to the Pull servers

    .PARAMETER PullServers
        Specify the list of Pull servers. The default value is H38-PR-IA-DSC02.ressources.paris.mdp
    
    .PARAMETER PullArtefactsPath
        The path on Pull servers to the modules and configurations. The default value is C:\PullServer
#>
[CmdletBinding()]
param
(
